...
class Student:  #student class
    def __init__(self,id,name,percentage):   # init method - it is a built-in method, it is called automatically when class is called, it sets the prooperties of object
        self.id = id   # creating instance
        self.name = name   # creating instance
        self.percentage = percentage     #object ko properties
    ...
    def details(self):  #user defined method  , we passs self parameter here because we want to access the properties of that object which called this method
        print(f"Hello, I am {self.name}. My student id is {self.id}. My percentage in 10th is {self.percentage}")
        
# s1 = Student("S001","Ram",9800)  # creating object s1
# s1.details()   #calling the method details() using s1 object
s2 = Student("I009","Marry",85.9)
s2.details()
s3 = Student("G008","Harry",87.5)
s3.details()
